...
RSpec.configure do |config|
  config.include Panda::Core::AuthenticationHelpers, type: :request
  config.include Panda::Core::AuthenticationHelpers, type: :system
end
